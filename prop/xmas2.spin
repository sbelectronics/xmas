...
**
**  smbaker: modified to store output_pin_mask in a register rather
**           than in DAT, so object can be used multiple times.
}}
...
cog_init    mov     t1, par                 ' Read v_output_pin_mask into output_pin_mask register
            add     t1, #4
            rdlong  output_pin_mask, t1 

            or      dira, output_pin_mask   ' Initialize output pin direction
